...
import sty from "./PlasmicIcon.module.css"; // plasmic-import: OMlRT0ZkDECn/css

import Icon14Icon from "./icons/PlasmicIcon__Icon14"; // plasmic-import: 8Ie3C7Dvs3nf/icon
...
function PlasmicIcon__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__s7YKp)}>
        {renderPlasmicSlot({
          defaultContents: (
            <Icon14Icon
              className={classNames(projectcss.all, sty.svg__iNElN)}
              role={"img"}
            />
          ),
      ...
      <div className={classNames(projectcss.all, sty.freeBox__k9J9G)}>
        {renderPlasmicSlot({
          defaultContents: (
            <div
              className={classNames(
