...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: kbPkSE6WXfXQ/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__mbio4)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__iyJ4O)}
              role={"img"}
            />
          ),
