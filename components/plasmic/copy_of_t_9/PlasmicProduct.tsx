...
import sty from "./PlasmicProduct.module.css"; // plasmic-import: TfZERPPFUwbP/css
...
function PlasmicProduct__RenderFunc(props: {
  ...
  return (
    <Stack__
      ...
      platform={"nextjs"}
    >
      <div className={classNames(projectcss.all, sty.freeBox__wPyu9)}>
        {renderPlasmicSlot({
          defaultContents: (
            <ProductMedia
              className={classNames("__wab_instance", sty.productMedia___6AmMy)}
            />
          ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__pwqKp)}
      >
        <h3
