...
import sty from "./PlasmicButton.module.css"; // plasmic-import: FmwlxDiCew1-/css
    ...
    <Stack__
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_star]: hasVariant($state, "color", "star"),
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__o3U3E)}
                role={"img"}
              />
            ),
      ...
      >
        {renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetChildren, {
            ...
            [sty.slotTargetChildrencolor_star]: hasVariant(
              $state,
              "color",
              "star"
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__tPgan)}
                role={"img"}
              />
            ),
